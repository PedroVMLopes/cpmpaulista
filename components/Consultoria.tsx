export default function Consultoria() {
    return (
        <div className="text-center flex flex-col items-center mt-24">
            <h1 className="text-3xl md:text-4xl mb-12">Consultoria Empresarial</h1>
            <div className="flex flex-col w-full text-start border-2 gap-0.5 rounded-2xl shadow-xl">
                <div className="collapse collapse-arrow bg-base-100 rounded-b">
                ...
                <div className="collapse collapse-arrow bg-base-100 rounded">
                ...
                <div className="collapse collapse-arrow bg-base-100 rounded-t">
                    <input type="radio" name="accordion-ServicosParaEmpresas" />
