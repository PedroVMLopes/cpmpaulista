export default function Consultoria() {
    return (
        <div className="text-center flex flex-col items-center mt-24">
            ...
            <div className="join join-vertical rounded-2xl w-full text-start">
                <div className="collapse collapse-arrow join-item border border-neutral bg-base-100">
                ...
                <div className="collapse collapse-arrow join-item border bg-base-100">
