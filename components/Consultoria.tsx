    ...
    return (
        <div className="text-center flex flex-col items-center mt-24">
            ...
            <div className="flex flex-col w-full text-start rounded-2xl gap-1">
                <div className="collapse collapse-arrow bg-secondary text-base-300 rounded-b p-2">
                ...
                <div className="collapse collapse-arrow bg-secondary text-base-300 rounded p-2">
                ...
                <div className="collapse collapse-arrow bg-secondary text-base-300 rounded-t p-2">
                    <input type="radio" name="accordion-ServicosParaEmpresas" />
