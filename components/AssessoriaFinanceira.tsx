...
export default function AssessoriaFinanceira() {
    ...
    return (
        <div className="text-center flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-rows-2 md:grid-cols-2 gap-0.5 md:gap-4 w-full p-2 md:p-4 mt-10 text-start rounded-2xl border-2 border-b-8">

                {/* Grid 1 */}
                <div className="indicator w-full flex flex-col rounded-2xl rounded-b-none md:rounded-r-none bg-base-200 text-center md:text-start">
                ...
                {/* Grid 2 */}
                <div className="indicator w-full flex flex-col md:rounded-tr-2xl bg-base-200 text-center md:text-start">
                    <div className="text-2xl p-4 pt-6 pb-0 flex flex-row items-center gap-2">
                ...
                {/* Grid 3 */}
                <div className="indicator w-full flex flex-col md:rounded-bl-2xl bg-base-200 text-center md:text-start">
                    <div className="text-2xl p-4 pt-6 pb-0 flex flex-row items-center gap-2">
                ...
                {/* Grid 4 */}
                <div className="indicator w-full flex flex-col rounded-2xl rounded-t-none md:rounded-bl-none md:rounded-br-2xl bg-base-200 text-center md:text-start">
                    <div className="text-2xl p-4 pt-6 pb-0 flex flex-row items-center gap-2">
