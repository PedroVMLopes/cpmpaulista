...
export default function FooterBottomCards() {
    return (
        <div className="mt-16 w-full flex-col flex items-center justify-center pt-10 pb-4 mx-2 md:mx-0 bg-base-300 rounded-t-lg">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full md:w-[75%] px-4 md:px-0">
                <p className="w-full text-center text-2xl md:text-3xl text-shadow-md text-primary flex items-center">Deseja simplificar seus processos financeiros e ter mais tempo para dedicar onde importa? Então entre em contato conosco:</p>
            ...
            {/* Copyright Text */}
            <p className="text-sm opacity-50 mt-10 px-4 md:px-0 text-center">© 2025 CPMPaulista - Todos os direitos reservados | Design e Desenvolvimento por <a href="https://pvlopes.vercel.app" target="_blank" className="underline">PedroVMLopes</a></p>
        </div>
    )
}